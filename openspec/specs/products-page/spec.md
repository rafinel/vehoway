## Purpose
Definir os requisitos canônicos da página pública de produtos da Vehoway, cobrindo descoberta navegável com query params, filtros e busca, paginação, detalhe responsivo e comportamento quando não há catálogo associado.
